...
// v1.14 · saveLocalDb: strip eltávolítva, IDB intercept kezeli (kp-mod-photo-idb)
(function(){
'use strict';
...
function saveLocalDb(d){
  ...
  try{rawSave(d);}
    ...
    if(isQuota(e)){
      try{rawSave({...d,fishImages:{}});console.warn('[KP restore] iOS quota: fishImages törölve');}
